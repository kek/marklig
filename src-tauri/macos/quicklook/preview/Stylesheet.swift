// Stylesheet inlined into the Quick Look preview HTML.
//
// Mirrors src/export/styles.ts so a Quick Look preview looks identical to
// Viewer's HTML export and reading mode. Keep these two in rough sync — when
// the in-app reading typography changes, port the diff here.

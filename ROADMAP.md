...
| **D. OS integration** | File associations, drag-drop polish, OS-level Recents, native menu polish, optional folder/project tree, multi-window UX | 🟡 Partial 2026-05-09 (file associations, folder tree, multi-window, last-file restore done; OS-level Recents and per-window watcher deferred) |

...
export const EN = {
  ...
  "sidebar.folder.empty": "No documents in this folder.",
  ...
  "sidebar.folder.newFileTitle": "Create a new document in this folder",
  ...
  "sidebar.folder.openMenu": "Open",
  "sidebar.folder.renameMenu": "Rename…",
  "sidebar.folder.deleteMenu": "Delete…",
  "sidebar.folder.renameAriaLabel": "New name for this file",
  "sidebar.folder.renameErrorEmpty": "Enter a file name.",
  "sidebar.folder.renameErrorSlash": "Subfolders aren't supported here — leave out the “/”.",
  "sidebar.folder.renameErrorExists": "A file with that name already exists.",
  "sidebar.folder.renameErrorWrite": "Could not rename file: {message}",
  "sidebar.folder.deleteTitle": "Delete file",
  "sidebar.folder.deleteBody": "Delete {name}? It will be moved to the trash.",
  "sidebar.folder.deleteConfirm": "Delete",
  "sidebar.folder.deleteCancel": "Cancel",
  "sidebar.folder.deleteErrorWrite": "Could not delete file: {message}",
